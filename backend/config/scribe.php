...
return [
    ...
    'title' => 'Dehasoft Case API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Laravel 12 e-commerce API for the Dehasoft case study. JWT authentication, multi-currency display backed by daily TCMB exchange rates, and a transactional checkout flow with admin-gated order completion.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            This API is consumed via the Next.js BFF proxy and never directly by browsers. All endpoints live under `/api/v1/*`. Authentication uses JWT bearer tokens issued by `POST /auth/login` and `POST /auth/register`.
    ...
    'auth' => [
        ...
        // Endpoints are public by default; protected endpoints opt in via @authenticated.
        'default' => false,
        ...
        'extra_info' => 'Obtain a token by calling <code>POST /api/v1/auth/login</code> with the seeded demo credentials (<code>customer@dehasoft.test</code> or <code>admin@dehasoft.test</code>, password <code>password</code>) and copy the <code>data.access_token</code> from the response.',
    ],
    ...
    'groups' => [
        ...
        // Sidebar order — keeps the docs grouped by domain in the order the case spec lists them.
        'order' => [
            'Meta',
            'Auth',
            'Products',
